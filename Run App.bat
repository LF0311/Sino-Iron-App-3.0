...
REM Check if App_0_0_7_2.py file exists
set "APP_FILE=%CURRENT_DIR%App_0_0_7_2.py"
if not exist "%APP_FILE%" (
    echo Error: App_0_0_7_2.py file not found!
...
if %errorlevel% neq 0 (
    ...
    echo 2. Does App_0_0_7_2.py file have syntax errors
